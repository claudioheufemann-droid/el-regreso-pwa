...
Robot que cada día descarga el informe de **Ventas Detalladas** desde
**Gestión Cervecera** y lo sube a la PWA, sin intervención manual.

```
GitHub Actions (diario 11:00 UTC)
