...
// Estado de las sincronizaciones automáticas (Clientes/Deudores) para mostrar
// en el admin dentro de la app, sin tener que ir a GitHub Actions a revisar.
// Lee `erp_sync_log`, que escriben /api/clientes/upload y /api/deudores/upload
// en cada corrida (automática vía el workflow de GitHub, o manual desde acá).
