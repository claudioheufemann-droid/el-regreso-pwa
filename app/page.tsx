    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 11, color: '#7A7268', marginTop: 6, letterSpacing: 1.5 }}>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: '#7A7268', lineHeight: 1.4 }}>
                  Dashboard, metas, clientes y mapa de ventas
                </div>
              </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 10, color: '#2A2520', marginTop: 32, letterSpacing: 1 }}>
