...
import { BarChart2, TrendingUp, Target, Upload, Map, Users, BarChart, FileUp, Route, AlertCircle } from 'lucide-react'
...
const navItems: SidebarNavItem[] = [
  ...
  { href: '/ventas/admin/deudores',         icon: AlertCircle,  label: 'Deudores',  adminOnly: true  },
